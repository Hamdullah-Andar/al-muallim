...
export default async function StudentDashboard() {
  ...
  const completedTasks = progress?.filter(p => p.is_completed).length || 0
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 md:p-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-6">
        ...
        {/* Next Prayer Widget (Static for now as per design) */}
        <div className="flex items-center bg-blue-50 dark:bg-blue-900/20 px-6 py-4 rounded-2xl gap-4">
           <div className="text-right">
             <p className="text-xs font-bold text-blue-800/60 dark:text-blue-200/60 uppercase tracking-wider mb-1">Next Prayer</p>
             <p className="font-bold text-blue-900 dark:text-blue-100">Asr • 3:45 PM</p>
           </div>
           <div className="w-10 h-10 rounded-full border-2 border-blue-900/20 flex items-center justify-center text-blue-900 dark:text-blue-100">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-black/40 p-6 rounded-3xl border border-black/5 dark:border-white/5 shadow-sm relative overflow-hidden">
            ...
            <div className="inline-block bg-primary-100 dark:bg-primary-900/40 text-primary-700 dark:text-primary-300 text-xs font-bold px-3 py-1 rounded-full mb-4">Consistency</div>
            <h3 className="text-2xl font-bold mb-2">1 Day Streak</h3>
            ...
            <div className="h-2 w-full bg-primary-100 dark:bg-primary-900/40 rounded-full overflow-hidden">
              <div className="h-full bg-primary-500 w-[10%] rounded-full"></div>
            </div>
          </div>

          {/* Big Zikr Card */}
          <div className="bg-primary-900 p-8 rounded-3xl text-white shadow-lg relative overflow-hidden">
            <h3 className="text-xl font-bold mb-1">Zikr Counter</h3>
            <p className="text-primary-200 text-sm mb-10">Daily Dhikr</p>
            <div className="text-center mb-10">
              <span className="text-6xl font-bold font-arabic block mb-6">{totalTasks}</span>
            ...
            <div className="flex justify-between text-xs text-primary-300 font-medium">
              <span>Daily Goal: {totalTasks}</span>
        ...
        <div className="lg:col-span-2">
          <div className="bg-white dark:bg-black/40 p-6 md:p-8 rounded-3xl border border-black/5 dark:border-white/5 shadow-sm h-full">
            ...
            <div className="flex justify-between items-center mb-8">
              ...
              <div className="text-right">
                <p className="text-3xl font-bold text-primary-600 dark:text-primary-400">{completedTasks}/{totalTasks}</p>
              </div>
            </div>
              ...
              <div className="space-y-6">
                {categories.map(category => (
                  <div key={category} className="space-y-3">
                    {/* The sleek Desktop Mockup Category headers */}
